...
#ifdef USE_ADS1115_ANALOG_READ
        // init ads1115 to instead of analog that builds-in Arduino.
        // Serial2.println("ads1115Init\r\n");
        ads1115Init();
#endif
      }
      break;
...
#ifdef USE_ADS1115_ANALOG_READ
// -----------------------------------------------------------------------------
/* init  ads1115 16-bit adc
 */
bool ads1115Init(void)
{
    if (!ads.begin(0x48))
      return false;
  ...
  if (analogPin < TOTAL_ANALOG_PINS) {
    if (value == 0) {
      ...
      if (!isResetting) {
        ...
        // reconnecting.
#ifdef USE_ADS1115_ANALOG_READ
        Firmata.sendAnalog(analogPin, ads1115AnalogRead(analogPin));
#else
