...
void RS485SerialFirmata::update()
{
  checkSerial();
}

void RS485SerialFirmata::reset()
{
#if defined(SoftwareSerial_h)
  Stream *serialPort;
...
Stream* RS485SerialFirmata::getPortFromId(byte portId)
{
  switch (portId) {
    case HW_SERIAL0:
...
void RS485SerialFirmata::checkSerial()
{
